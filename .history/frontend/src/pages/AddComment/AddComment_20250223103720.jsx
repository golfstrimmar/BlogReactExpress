...
import { addComment, updateComment } from "../../redux/actions/commentActions";
...
const AddComment = ({ mode }) => {
  ...
  useEffect(() => {
    ...
    socket.on("commentEvent", handleCommentEvent);
    return () => socket.off("commentEvent", handleCommentEvent);
